...
class LdapServiceSpec extends Specification {
    ...
    def "Create Entry"() {
        def contact1 = new Contact(dn: "name=test1,o=fint.no", firstName: "Ole", lastName: "Olsen")
        def contact2 = new Contact(dn: "name=test2,o=fint.no", firstName: "Ola", lastName: "Hansen")
